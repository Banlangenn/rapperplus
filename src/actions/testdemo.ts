...
/**
* 接口名：goodsQbf
* Rap 地址: http://rap2.taobao.org/repository/editor?id=284428&mod=476168&itf=2072184
*/
export const goodsQbf = createFetch<IReqGoodsQbf, IResGoodsQbf>("/c/api/1.0/approve/goods/qbf", "GET");
/**
* 接口名：goodsAudit
* Rap 地址: http://rap2.taobao.org/repository/editor?id=284428&mod=476168&itf=2072183
*/
